...
function renderEntities(q=''){
  ...
  $('#entitiesGrid').innerHTML=a.map(e=>`
    <article class="si-panel si-entity-card" data-entity="${e.id}" style="position:relative">
      <span
      ...
      <div class="si-card-stats">
        ...
        <div class="si-card-stat">
          <strong class="${entityMetricClass(e,'avgProfitUsd')}">${entityMetricMoney(e,'avgProfitUsd')}</strong>
          <small>Avg / Token</small>
        </div>
      </div>
    </article>
...
function entityDetailRankHtml(e){
  ...
  return rank
    ? `<span class="si-entity-rank" aria-label="Rank ${rank}" title="Profit rank" style="position:absolute;top:24px;right:24px;font-size:18px;font-weight:700;line-height:1;opacity:.52;pointer-events:none">#${rank}</span>`
    : '';
}
...
function entityDetailLoading(e){
  ...
  modal(`<div class="si-detail-layout">
    <aside class="si-detail-side">
      <div class="si-panel si-entity-profile-panel" style="box-shadow:none;position:relative">
